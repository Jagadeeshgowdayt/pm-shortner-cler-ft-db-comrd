...
SECOND_SHORTLINK_URL = environ.get('SECOND_SHORTLINK_URL', 'moneycase.linkt')
...
GRP_LNK = environ.get('GRP_LNK', 'https://telegram.me/kannadahdall')
CHNL_LNK = environ.get('CHNL_LNK', 'https://telegram.me/kannadahdall')
UPDATE_CHANNEL = environ.get('CHNL_LNK', 'https://telegram.me/kannadahdall')
MSG_ALRT = environ.get('MSG_ALRT', '❤ ᴊᴏɪɴ @kannadahdall ❤')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001945879112))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'kannadahdall')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
TUTORIAL = environ.get('TUTORIAL', 'https://telegram.me/kannadahdall')
BUY_PREMIUM = environ.get('TUTORIAL', 'https://telegram.me/kannadahdall')
