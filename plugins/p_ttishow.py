...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="telegram.me/PS_MOV_BOT")
                  ]]
        reply_markup=InlineKeyboardMarkup(buttons)
...
async def leave_a_chat(bot, message):
    ...
    try:
        buttons = [[
            InlineKeyboardButton('Support Group', url="https://telegram.me/+4nzja42ELQwzOWVl"),
            InlineKeyboardButton('Owner', url="https://telegram.me/PS_MOV_BOT")
        ],[
